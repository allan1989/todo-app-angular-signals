...
describe('AppComponent', () => {
  ...
  it('displays the correct title', () => {
    ...
    const targetDOM = fixture.debugElement.query(
      By.css('.header_title')
  ...
  it('should display a list when there are todos and filtered todos', () => {
    ...
    app.todos.set(dummyData);
    app.filteredTodos.set(dummyData);
